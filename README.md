...
> **Status**: Fork based on Ollama **v0.30.11**. Tested on Jetson AGX Thor with JetPack 7.2 (CUDA 13.2, compute capability 11.0). Builds cleanly on Ubuntu 24.04 for arm64.
